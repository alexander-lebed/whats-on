...
import { LANGUAGES, SITE_BASE_URL } from '@/app/constants';
...
const FALLBACK_OG_IMAGE = `${SITE_BASE_URL}/square-orange.png`;
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const canonical = `${SITE_BASE_URL}/${locale}/events/${event.slug}`;
  const languages = Object.fromEntries(
    LANGUAGES.map(l => [l.locale, `${SITE_BASE_URL}/${l.locale}/events/${event.slug}`])
  );
